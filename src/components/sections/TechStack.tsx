    ...
    <section className="bg-brand-gradient">
      <div className="container mx-auto flex flex-col items-center justify-center px-4 py-8 sm:px-6 sm:py-12">
        <h2
          ...
          className="font-Outfit text-center text-3xl font-medium text-white sm:text-4xl"
        >
          Technologies I use
        </h2>
        <div
          ...
          className="tech-stack mt-4 flex max-w-5xl flex-wrap items-center justify-center gap-2 px-2 md:mt-6"
        >
